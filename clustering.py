...
f=open('Book1.csv',encoding="utf8")
samples=[]
SAMPLES=[]
...
samples=samples[1:]
for i in samples:
	SAMPLES.append(list(map(int,i)))
TOTAL_DATA = len(SAMPLES)
print ("Total Number of data to be clustered:",TOTAL_DATA)
#SAMPLES consists of data loaded from the csv file consisting of height and weight
